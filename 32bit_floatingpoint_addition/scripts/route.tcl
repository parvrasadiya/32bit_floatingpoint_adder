...
#
#
write_verilog ./results/fp_adder.routed.v
write_sdc -output ./results/fp_adder.routed.sdc
write_parasitics -format spef -output ./results/fp_adder_${scenario1}.spef
#
